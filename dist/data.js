...
const ACHIEVEMENTS=[
 ...
 {id:'easy_clear',icon:'◆',name:'하수도 정복자',desc:'잔향 하수도를 완주한다.',reward:2},
 {id:'hard_clear',icon:'▲',name:'대기권 돌파',desc:'대기권 균열을 완주한다.',reward:4},
 {id:'xion_clear',icon:'✦',name:'차원의 지배자',desc:'XION 심층을 완주한다.',reward:8},
 {id:'collector10',icon:'◇',name:'냄새 수집가',desc:'서로 다른 지냄 10종을 모은다.',reward:2},
 {id:'collector36',icon:'◈',name:'완전한 도감',desc:'지냄 36종을 모두 모은다.',reward:10},
 {id:'super_hit',icon:'◎',name:'상성 박사',desc:'효과가 굉장한 공격을 처음 적중시킨다.',reward:1},
